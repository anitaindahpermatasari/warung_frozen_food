...
<div class="row">
    <div class="col-sm-12 col-md-10">
        <h4 class="mb-0"><i class="fa fa-reply"></i> Edit Data Penjualan Frozen Food</h4>
    </div>
</div>
<hr class="mt-0" />
<div id="message">
...
<div class="col-md-12">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-6">
            <input type="text" name="pembeli" id="pembeli" class="form-control form-control-sm <?= (form_error('pembeli')) ? 'is-invalid' : ''; ?>" placeholder="Masukkan Nama Pembeli" value="<?= (set_value('pembeli')) ? set_value('pembeli') : $fdata->nama_pembeli; ?>">
            <div class="invalid-feedback">
