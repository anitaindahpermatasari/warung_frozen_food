...
<body>
 ...
 title: 'ANDA YAKIN INGIN KELUAR SEKARANG???', type: 'warning' , showCancelButton: true, confirmButtonColor: '#DD6B55' , confirmButtonText: 'IYA SEKARANG AJA!!!', closeOnConfirm: false }, function(){ window.location.href = '<?= site_url('sign_out'); ?>'; });">Sign Out</a>
                                </div>
                            </li>
                        </ul>
                    </div>
                ...
                $.ajax({
                    ...
                    success: function(obj) {
                        ...
                        if (x.message == 'success') {
                            swal({
                                title: "Success!",
                                text: " Selamat Data Frozen Food Berhasil Dihapus",
                                type: "success",
                            ...
                            swal({
                                title: "Error!",
                                text: "Maaf Data Frozen Food Gagal Dihapus",
                                type: "error",
                                showCancelButton: false,
                                showConfirmButton: false,
                                timer: 2000
                ...
                $.ajax({
                    ...
                    success: function(obj) {
                        ...
                        if (a.message == 'success') {
                            ...
                            swal({
                                title: "Error!",
                                text: "Selamat Data Frozen Food Gagal Dihapus",
                                type: "error",
                                showCancelButton: false,
                                showConfirmButton: false,
                                timer: 2000
                ...
                $.ajax({
                    ...
                    success: function(obj) {
                        ...
                        if (a.message == 'success') {
                            swal({
                                title: "Success!",
                                text: "Selamat Data Distributor Berhasil Dihapus",
                                type: "success",
                                showCancelButton: false,
                                showConfirmButton: false,
                                timer: 2000
                            ...
                            swal({
                                title: "Error!",
                                text: "Maaf Data Distributor Gagal Dihapus",
                                type: "error",
                                showCancelButton: false,
                                showConfirmButton: false,
                                timer: 2000
