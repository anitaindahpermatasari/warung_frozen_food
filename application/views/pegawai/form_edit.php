...
<div class="row">
    <div class="col-sm-12 col-md-10">
        <h4 class="mb-0"><i class="fa fa-users"></i> Edit Data Karyawan</h4>
    </div>
</div>
<hr class="mt-0" />
<?= form_open_multipart(); ?>
<div class="col-md-8">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <input type="text" class="form-control form-control-sm <?= (form_error('username')) ? 'is-invalid' : ''; ?>" id="username" required autofocus name="username" placeholder="Masukkan Username" value="<?= (set_value('username')) ? set_value('username') : $pegawai->username; ?>">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <input type="text" class="form-control form-control-sm <?= (form_error('fullname')) ? 'is-invalid' : ''; ?>" id="fullname" name="fullname" placeholder="Masukkan Nama Lengkap" value="<?= (set_value('fullname')) ? set_value('fullname') : $pegawai->fullname; ?>">
            <div class="invalid-feedback">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-5">
            <input type="text" class="form-control form-control-sm hp <?= (form_error('hp')) ? 'is-invalid' : ''; ?>" id="hp" name="hp" placeholder="Masukkan Nomor Telepon" value="<?= (set_value('hp')) ? set_value('hp') : $pegawai->hp; ?>">
            <div class="invalid-feedback">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <textarea class="form-control form-control-sm <?= (form_error('alamat')) ? 'is-invalid' : ''; ?>" id="alamat" rows="2" name="alamat" placeholder="Masukkan Alamat Lengkap"><?= (set_value('alamat')) ? set_value('alamat') : $pegawai->alamat; ?></textarea>
            <div class="invalid-feedback">
