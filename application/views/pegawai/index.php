...
<div class="row">
    <div class="col-sm-12 col-md-10">
        <h4 class="mb-0"><i class="fa fa-users"></i> Data Karyawan</h4>
    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <label for="password-baru">Password Baru Karyawan</label>
                    <input type="password" class="form-control form-control-sm" id="password-baru" name="pwUser" placeholder="Masukkan Password Baru Karyawan">
                </div>
                <div class="form-group">
                    <label for="password-admin">Password Admin</label>
                    <input type="password" class="form-control form-control-sm" id="password-admin" name="pwAdmin" placeholder="Masukkan Password Admin">
                </div>
            </div>
