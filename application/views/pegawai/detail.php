...
<div class="row">
    <div class="col-sm-12 col-md-10">
        <h4 class="mb-0"><i class="fa fa-users"></i> Detail Karyawan</h4>
    </div>
</div>
<hr class="mt-0" />
    ...
    <div class="row no-gutters">
        ...
        <div class="col-md-8 offset-md-1">
            <div class="card-body pt-1">
                ...
                <p class="card-text mb-0"><b>Nomor Telepon :</b></p>
                <p class="card-text text-mute"><?= ($data->hp != '') ? $data->hp : '-'; ?></p>
                <p class="card-text mb-0"><b>Alamat Lengkap :</b></p>
                <p class="card-text text-muted"><?= ($data->alamat != '') ? $data->alamat : '-'; ?></p>
                <p class="card-text mb-0"><b>Status Karyawan :</b></p>
                <p class="card-text text-muted"><?= ($data->active == 'Y') ? 'Karyawan Aktif' : 'Karyawan Tidak Aktif'; ?></p>
