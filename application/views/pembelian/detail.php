...
<div class="row">
    <div class="col-sm-12 col-md-10">
        <h4 class="mb-0"><i class="fa fa-share"></i> Detail Pengadaan Frozen Food</h4>
    </div>
</div>
<hr class="mt-0" />
<h6 class="mb-2">ID Pengadaan</h6>
<p class="text-muted display-5 mt-1 mb-2">#<?= $d->id_pembelian; ?> ( <?= tanggal_indo($d->tgl_pembelian); ?> )</p>
<h6 class="mb-1 mt-2">Distributor</h6>
...
<table class="table table-sm table-hover">
    ...
    <tbody>
        ...
        <?php endforeach; ?>
        <tr>
            <td colspan="6" class="text-center"><b>Biaya Total Pengadaan</b></td>
            <td>
                <b>
                    <span class="float-left">Rp.</span>
                    <span class="float-right pr-3">
