...
<div class="row">
    <div class="col-sm-12 col-md-10">
        <h4 class="mb-0"><i class="fa fa-share"></i> Tambah Data Pengadaan Frozen Food</h4>
    </div>
</div>
<hr class="mt-0" />
<div id="message">
...
<div class="col-md-12">
    <div class="form-group row">
        <label for="tanggal" class="col-sm-2 col-form-label">Tanggal Pengadaan</label>
        <div class="col-sm-3">
    ...
    <div class="form-group row">
        <label for="supplier" class="col-sm-2 col-form-label">Distributor</label>
        <div class="col-sm-6">
    ...
    <div class="form-group row">
        <label for="barangx" class="col-sm-2 col-form-label">Frozen Food</label>
        <div class="col-sm-6">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-2">
            <input type="number" class="form-control form-control-sm" id="jumlahx" placeholder="Masukkan Jumlah Pengadaan">
        </div>
    </div>
    <div class="form-group row">
        <label for="harga" class="col-sm-2 col-form-label">Harga Satuan</label>
        <div class="col-sm-3">
            <input type="text" class="form-control form-control-sm uang" id="harga" placeholder="Masukkan Harga Satuan">
        </div>
    </div>
    <div class="form-group row">
        <div class="col-sm-3 offset-sm-2">
            ...
            <div id="btn-act">
                <button type="button" class="btn btn-success btn-sm" onclick="tambah_cart()">Tambah Frozen Food</button>
            </div>
        </div>
    </div>
        ...
        <table class="table table-sm table-hover">
            <thead class="thead-dark">
                <tr>
                    ...
                    <th scope="col" class="text-right">Total Harga Pengadaan</th>
    ...
    <div class="col-sm-4 offset-sm-8">
        <button type="submit" name="submit" class="btn btn-primary btn-sm" value="Submit">
            <i class="fa fa-save"></i> Simpan Data Pengadaan
        </button>
