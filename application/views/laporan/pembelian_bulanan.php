...
<div class="row">
    <div class="col-sm-12 col-md-10">
        <h4 class="mb-0"><i class="fa fa-file-text"></i> Laporan Bulanan Pengadaan Frozen Food</h4>
    </div>
</div>
<hr class="mt-0" />
<?php
...
<table class="table table-sm table-bordered mt-3">
    <thead class="thead-dark">
        <tr>
            ...
            <th scope="col">Merk Forzen Food</th>
    ...
    <tbody>
        ...
        if ($data->num_rows() > 0) {
            ...
            echo '<tr>';
            echo '<td colspan="8" class="text-center"><b>Biaya Total Pembelian</b></td>';
            echo '<td><b><span class="float-left">Rp.</span><span class="float-right">' . number_format($total, 0, ',', '.') . '</span></b></td>';
            echo '</tr>';
        } else {
            echo '<tr>';
            echo '<td colspan="9" class="text-center">Belum Ada Data Pembelian Bulanan</td>';
            echo '</tr>';
        }
        ?>
    </tbody>
