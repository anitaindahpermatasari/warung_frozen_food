...
<h6 class="display-5 text-center mt-2 mb-0">Laporan Bulanan Pengadaan Frozen Food</h6>
...
<table class="table table-sm table-bordered mt-3">
    ...
    <tbody>
        ...
        if ($data->num_rows() > 0) {
            ...
            echo '<tr>';
            echo '<td colspan="8" class="text-center"><b>Biaya Total Pengadaan</b></td>';
            echo '<td><b><span class="float-left">Rp.</span><span class="float-right">' . number_format($total, 0, ',', '.') . '</span></b></td>';
            echo '</tr>';
        } else {
            echo '<tr>';
            echo '<td colspan="9" class="text-center">Belum Ada Data Pengadaan Bulanan/td>';
            echo '</tr>';
        }
        ?>
    </tbody>
