...
class Penjualan extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data = [
            'title' => 'Data Penjualan Frozen Food'
        ];
    ...
    public function tambah_data()
    {
        ...
        if ($this->input->post('submit', TRUE) == 'Submit') {
            ...
            if (!$this->cart->contents()) {
                $this->session->set_flashdata('alert', 'Maaf Anda Belum Memilih Frozen Food. Silahkan Memilih Terlebih Dahulu.');
            ...
            if ($this->form_validation->run() == TRUE) {
                ...
                if ($simpan) {
                    ...
                    $this->session->set_flashdata('success', 'Selamat Data Penjualan Berhasil Di Tambahkan');
        ...
        $data = [
            'title' => 'Tambah Data Penjualan Frozen Food',
    ...
    public function detail_penjualan($id_penjualan = null)
    {
        ...
        $data = [
            'title' => 'Detail Penjualan Frozen Food' . $id_penjualan,
            'data' => $getData
        ];
    ...
    public function edit_penjualan($id = null)
    {
        ...
        if ($this->input->post('submit', TRUE) == 'Submit') {
            ...
            if ($this->form_validation->run() == TRUE) {
                ...
                if ($update) {
                    ...
                    $this->cart->destroy();
                    //buat notifikasi penyimpanan berhasil
                    $this->session->set_flashdata('success', 'Selamat Data Penjualan Berhasil Di Ubah');
        ...
        $data = [
            'title' => 'Edit Data Penjualan Frozen Food',
            'fdata' => $fData,
            'data' => $this->m_penjualan->getData('tbl_barang', ['active' => 'Y']),
            'table' => $this->read_cart()
        ];
        ...
        if ($this->input->is_ajax_request()) {
            ...
            if ($this->form_validation->run() == TRUE) {
                ...
                if ($getBarang->num_rows() == 1) {
                    ...
                    $table = $this->read_cart();
                    $alert = '<div class="alert alert-danger" role="alert">Maaf Data Frozen Food Tidak Di Temukan.</div>';
            ...
            if ($this->form_validation->run() == TRUE) {
                ...
                if ($get_barang->num_rows() == 1) {
                    ...
                    if ($this->security->xss_clean($this->input->post('qty', TRUE)) > $stok) {
                        ...
                        $alert = '<div class="alert alert-danger" role="alert">Maaf Jumlah Pembelian Melebihi Stok Frozen Food Yang Tersedia.</div>';
                        ...
                        $alert = '<div class="alert alert-success" role="alert">Selamat Data Berhasil Di Tambahkan Ke Keranjang</div>';
                    ...
                    $alert = '<div class="alert alert-danger" role="alert">Maaf Data Frozen Food Tidak Dapat Di Temukan</div>';
    ...
    public function hapus_cart_penjualan()
    {
        ...
        if ($this->input->is_ajax_request()) {
            ...
            if ($this->form_validation->run() == TRUE) {
                ...
                $alert = '<div class="alert alert-success" role="alert">Selamat Data Berhasil Di Hapus</div>';
            ...
            if ($this->form_validation->run() == TRUE) {
                ...
                if ($get_barang->num_rows() == 1) {
                    ...
                    if ($this->security->xss_clean($this->input->post('qty', TRUE)) > $stok) {
                        ...
                        $alert = '<div class="alert alert-danger" role="alert">Maaf Jumlah Melebihi Stok Frozen Food Yang Tersedia</div>';
                        ...
                        $alert = '<div class="alert alert-success" role="alert">Selamat Data Berhasil Di Ubah</div>';
                    ...
                    $alert = '<div class="alert alert-danger" role="alert">Maaf Data Frozen Food Tidak Berhasil Di Temukan</div>';
    ...
    private function read_cart()
    {
        if ($this->cart->contents()) {
            ...
            $table = '<tr>
                        <td scope="col" colspan="6" class="text-center"><i>Belum Ada Data Penjualan Frozen Food Yang Di Tambahkan</i></td>
                    </tr>';
        }
