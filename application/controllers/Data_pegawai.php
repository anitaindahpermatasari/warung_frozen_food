    ...
    public function tambah_pegawai()
    {
        ...
        if ($this->input->post('submit', TRUE) == 'submit') {
            ...
            if ($this->form_validation->run() == TRUE) {
                ...
                if ($save) {
                    $this->session->set_flashdata('success', 'Selamat Data Karyawan Berhasil Di Tambahkan');
    ...
    public function edit_data($user = '')
    {
        ...
        if ($this->security->xss_clean($this->input->post('submit', TRUE)) == 'submit') {
            ...
            if ($this->form_validation->run() == TRUE) {
                ...
                if ($up) {
                    $this->session->set_flashdata('success', 'Selamat Data Karyawan Berhasil Di Update');
        ...
        if ($this->input->post('submit', TRUE) == 'Submit') {
            ...
            if ($this->form_validation->run() == TRUE) {
                ...
                if (password_verify($passwordAdmin, $a->password)) {
                    ...
                    if ($updated) {
                        $this->session->set_flashdata('success', 'Selamat Password Karyawan Berhasil Di Update');

                        redirect('pegawai');
                    } else {
                        $this->session->set_flashdata('error', 'Maaf Password Karyawan Gagal Di Update');

                        redirect('pegawai');
                    }
                } else {
                    $this->session->set_flashdata('error', 'Maaf Password Admin Salah! Password Karyawan Gagal Di Update!');
