    ...
    public function tambah_supplier()
    {
        ...
        if ($this->input->post('submit', TRUE) == 'submit') {
            ...
            if ($this->form_validation->run() == TRUE) {
                ...
                if ($simpan) {
                    $this->session->set_flashdata('success', 'Selamat Data Distributor Berhasil Di Tambahkan');
    ...
    public function edit_supplier($id)
    {
        ...
        if ($this->input->post('submit', TRUE) == 'submit') {
            ...
            if ($this->form_validation->run() == TRUE) {
                ...
                if ($up) {
                    $this->session->set_flashdata('success', 'Selamat Data Distributor Berhasil Di Update');
