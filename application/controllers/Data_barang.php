...
class Data_barang extends CI_Controller
{
    ...
    public function tambah_data()
    {
        ...
        if ($this->input->post('submit', TRUE) == 'submit') {
            ...
            if ($this->form_validation->run() == TRUE) {
                ...
                if ($save) {
                    $this->session->set_flashdata('success', 'Selamat Data Frozen Food Berhasil Di Tambah');
    ...
    public function edit_data($kode_barang = '')
    {
        ...
        //cek uri
        if ($kode_barang == '') {
            $this->session->set_flashdata('error', 'Maaf Data Tidak Valid');
        ...
        if ($this->input->post('update', TRUE) == 'Update') {
            ...
            if ($this->form_validation->run() == TRUE) {
                ...
                if ($up) {
                    $this->session->set_flashdata('success', 'Selamat Data Barang Berhasil Di Perbaharui');
