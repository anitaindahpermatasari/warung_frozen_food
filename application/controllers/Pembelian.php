...
class Pembelian extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data = [
            'title' => 'Data Pengadaan Frozen Food'
        ];
    ...
    public function tambah_data()
    {
        ...
        if ($this->input->post('submit', TRUE) == 'Submit') {
            ...
            if (!$this->cart->contents()) {
                $this->session->set_flashdata('alert', 'Maaf Anda Belum Memilih Frozen Food. Silahkan Pilih Terlebih Dahulu');
            ...
            if ($this->form_validation->run() == TRUE) {
                ...
                if ($simpan) {
                    ...
                    $this->session->set_flashdata('success', 'Selamat Data Pengadaan Berhasil Di Tambahkan');
        ...
        if ($this->input->post('submit', TRUE) == 'Update') {
            ...
            if ($this->form_validation->run() == TRUE) {
                ...
                if ($update) {
                    ...
                    $this->cart->destroy();
                    //buat notifikasi penyimpanan berhasil
                    $this->session->set_flashdata('success', 'Selamat Data Pengadaan Berhasil Di Update');
        ...
        if ($this->input->is_ajax_request()) {
            ...
            if ($this->form_validation->run() == TRUE) {
                ...
                if ($get_barang->num_rows() == 1) {
                    ...
                    $alert = '<div class="alert alert-danger" role="alert">Maaf Data Tidak Ditemukan. Silahkan Coba Lagi.</div>';
    ...
    private function read_cart()
    {
        if ($this->cart->contents()) {
            ...
            $table = '<tr>
                        <td scope="col" colspan="6" class="text-center"><i>Belum Ada Data Pengadaan Frozen Food Yang Di Tambahkan</i></td>
                    </tr>';
        }
