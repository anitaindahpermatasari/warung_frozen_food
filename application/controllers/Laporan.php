...
class Laporan extends CI_Controller
{
    ...
    public function data_stok_harian()
    {
        ...
        $data = [
            'title' => 'Laporan Harian Stok Frozen Food',
            'tanggal' => $tanggal,
            'data' => $getData
        ];
    ...
    public function data_stok_bulanan()
    {
        ...
        $data = [
            'title' => 'Laporan Bulanan Stok Frozen Food',
            'bulan' => $bulan,
            'tahun' => $tahun,
            'data' => $getData
        ];
    ...
    public function data_stok_tahunan()
    {
        ...
        $data = [
            'title' => 'Laporan Tahunan Stok Frozen Food',
            'tahun' => $tahun,
            'data' => $getData
        ];
    ...
    public function data_pembelian_harian()
    {
        ...
        $data = [
            'title' => 'Laporan Harian Pengadaan Forzen Food',
            'tanggal' => $tanggal,
            'data' => $getData
        ];
    ...
    public function cetak_pembelian_harian($date)
    {
        ...
        $data = [
            'title' => 'Laporan Harian Pengadaan Frozen Food',
            'tanggal' => $date,
            'data' => $getData
        ];
    ...
    public function data_pembelian_bulanan()
    {
        ...
        $data = [
            'title' => 'Laporan Bulanan Pengadaan Frozen Food',
            'bulan' => $bulan,
            'tahun' => $tahun,
            'data' => $getData
        ];
    ...
    public function data_penjualan_harian()
    {
        ...
        $data = [
            'title' => 'Laporan Harian Penjualan Frozen Food',
            'tanggal' => $tanggal,
            'data' => $getData
        ];
    ...
    public function data_penjualan_bulanan()
    {
        ...
        $data = [
            'title' => 'Laporan Bulanan Penjualan Frozen Food',
            'bulan' => $bulan,
            'tahun' => $tahun,
            'data' => $getData
        ];
